...
driver.get(
    "https://zakupy.auchan.pl/shop/artykuly-spozywcze/mleko-nabial-jaja/maslo-margaryny-tluszcze.c-28821"
)
time.sleep(3)
...
with open(os.path.join(current_path, "cookies.json"), "w") as file:
