...
class ShopSpider(scrapy.Spider):
    ...
    start_urls = ["https://zakupy.auchan.pl/api/v2/cache/products?categoryId=28821&itemsPerPage=15&page=1&cacheSegmentationCode=019_DEF&hl=pl"]
    custom_settings = {
    ...
    def start_requests(self):
        ...
        headers = {
            ...
            'accept-language': 'pl',
            'authorization': 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..gAyghmif5z1p7x0oGtLHE9WXlZOVUHlbsXF3i2Lcr_tIwPH3mZ5UrpsYetTITmsME7WsVJZzZ6Zv0UySMylFYWkjK949JvKOKtCQgEgREJ_oPYIh79JiP5BxA0MtBSmYwniawHcpZg1FuUtSSXs4NSwkDduiloIEGdHIA9NpA0GCrJDI81wlzAG1mFuEjJxHGZBZXlJy1KDHXvtMVVRqDKF_xbq4V6eCrNsO6hdN1DIa0MJ-sn_5eBDxqXrrz2_fiUEHMM12Ccbs9oKecuPxm3lzJ8tOw3wfo0cLybfspsfvCW8rBPKMDNjzg3g1sKy9KVOgcqLKspB8VP8kfH3coQ',
